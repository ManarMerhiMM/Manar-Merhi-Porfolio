...
import ThemeSwitch from "../Secondary/ThemeSwitch";
...
function NavBar(props) {
    ...
    useEffect(() => {
        const updateActiveSection = () => {
            ...
            const scrollPosition = window.scrollY + NAV_HEIGHT + 1;
    ...
    const navLinkClass = (path) =>
        `transition-colors duration-200 ${activeSection === path
    ...
    return (
        <nav className="bg-[#f2dfa8] dark:bg-[#28243a] border-b border-[#c9b989] dark:border-[#332f47] shadow-sm dark:shadow-none md:fixed md:top-0 md:z-50 md:w-full">
            ...
            <div className="h-20 flex items-center justify-between px-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    >
                        <span
                            className={`block h-0.5 w-5 rounded-full bg-current transition-all duration-300 ${menuOpen
                    ...
                    {links.map(({ name, path }) => (
                        <li key={path}>
                            <a
                                ...
                                className={mobileNavLinkClass(path)}
                            >
                                {name}
                            </a>
                        </li>
