function ProminentExperienceCard({ experience }) {
    const {
        company,
        role,
        type,
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                ...
                <div>
                    <div className="flex flex-wrap items-center gap-2">
                        <span className="font-mono text-sm text-[#b5650a] dark:text-[#f5a623]">
                            {type}
                        </span>
                        ...
                        <span className="font-mono text-sm text-[#8a7a4e] dark:text-[#8b86a3]">
                            {location}
                        </span>
                    </div>
...
export default ProminentExperienceCard;